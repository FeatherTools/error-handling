...
module AsyncResult =
    ...
    /// Run asyncResults in Parallel, handles the errors and concat results
    ...
    /// Run asyncs in Parallel, handles the errors and concat results
    ...
    /// Run asyncs in limited Parallel, handles the errors and concat results
    ...
    /// Run asyncResults in limited Parallel, handles the errors and concat results
