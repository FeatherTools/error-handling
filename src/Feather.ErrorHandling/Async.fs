...
module Async =
    ...
    /// See: https://stackoverflow.com/questions/26229949/f-cant-catch-timeoutexception/26230245#26230245
    let withTimeout millisecondsDueTime notInTimeValue xA = async {
        let! child = Async.StartChild(xA, millisecondsDueTime)
        try return! child
        with _ -> return notInTimeValue
    }
